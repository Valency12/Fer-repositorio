...
int main()
{
    ...
    do
    {
        ...
        do { //do while el funcionamiento de regresar a menus anteriores
            switch (tipo_usuario)
            {
                case 1:
                                ...
                                do {
                                    ...
                                    switch(opcion1){
                                        ...
                                        //lote es el campo oculto que se llenara automaticamente sin pedir ingreso
                                            ...
                                            cout <<endl; 
                                            cout << "  Ingrese el tipo de pack que compro: ";
                                        ...
                                        case 2:
                                            ...
                                            int regreso;
                                            ImprimirBebidas();
                                            cout << "Presione (1) volver al menu anterior" << endl;
                                            cin >> regreso;
                                            if(regreso == 1){
                                                regresarmenupro = 1;
                                                regresar = 0;
                        ...
                        switch(opcion){
                                    ...
                                    switch(opcion1){
                                        ...
                                        //lote es el campo oculto que se llenara automaticamente sin pedir ingreso
                                            ...
                                            if(bebida.tipo_bebida != 1 && bebida.tipo_bebida != 2 && bebida.tipo_bebida != 3){
                                                ...
                                                cin >> bebida.cantidad;
                                                cout << endl;
                                                cout << " El precio por pack es de $" << (bebida.precio/bebida.cantidad); 
                                        ...
                                        case 2:
                                            ...
                                            if(regreso == 1){
                                                ...
                                                cout << "Opcion no valida! Regresando...";
                                                regresarmenupro = 1;
                                                regresar = 0;
                                            }
                                        break;
                            ...
                            cout << endl; 
                                ...
                                do {
                                    switch(opcion1){
                                        case 1:
                                            //REVISAR ESTA PARTEEEEEEEE AHORAAAAA Y TERMINAMOS 
                                            ImprimirBebidas();
                                            cout << " Ingrese el nombre de la bebida: ";
                                            ...
                                            cout << endl;
                                            cout << "Informacion acerca del lote:" << endl;
